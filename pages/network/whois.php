...
<h2>Whois</h2>
  ...
  <?php
     ...
     echo '
      <form method="post">
      <td><input type="text" name="site" size="50" class="form-control" placeholder="Enter Host" /><center><br><input class="btn btn-outline-success" type="submit" name="scan" value="Scan" /></td></tr>
      </table></form></center>';
     if(isset($_POST['scan']))
     {
