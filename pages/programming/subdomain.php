...
<div class="main-panel">
  <div class="content-wrapper">
    <div class="page-header">
      <h3 class="page-title"> Subdomain Scanner </h3>
      <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="#">Programming</a></li>
          <li class="breadcrumb-item active" aria-current="page">Subdomain Scanner</li>
        </ol>
      </nav>
    </div>
    	...
    	<div class="row">
    	    ...
    	    <div class="card">
    	      <div class="card-body"><center>
    					<h2 class="card-title">Subdomain Scanner</h2></center>
                ...
                <div class="text-center">
    						...
    						<button type="submit" class="btn btn-outline-primary mb-3" name="encode">Submit</button>
              </div>
    					</form>
    	      </div>
    	    </div>
